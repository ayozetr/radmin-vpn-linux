...
# Native LD_PRELOAD shim: short-circuits reverse DNS of private IPv4 at the glibc
# layer for the Wine process (issue #16). run.sh LD_PRELOADs it into the service.
